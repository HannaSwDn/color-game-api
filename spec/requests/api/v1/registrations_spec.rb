RSpec.describe 'User Registration', type: :request do
  ...
  context 'with valid credentials' do
    it 'returns a user and token' do
      post '/api/v1/auth', params: { email: 'hannanyman.sk@gmail.com',
      	                            password: 'password',
  ...
  context 'returns an error message when user submits' do
    ...
    it 'an invalid email address' do
      post '/api/v1/auth', params: { email: 'hannanyman.sk@gmail',
                                    password: 'password',
                                    password_confirmation: 'password'
                                  }, headers: headers
    ...
    it 'an already registered email' do
      FactoryBot.create(:user, email: 'hannanyman.sk@gmail.com',
                              password: 'password',
                              password_confirmation: 'password')
